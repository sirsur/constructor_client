...
const setHrefContent = (content: string, element: string) => {
    const find = findElement(element);
    find.href = content;
}
    ...
    fontLink.onload = () => {
        try {
            if (find) {
                ...
                console.error('Link element not found in iframe body');
            }
        } catch (error) {
            console.error(error);
        }
...
const setTextDecoration = (decoration: string, element: string) => {
    const find = findElement(element);
    find.style.textDecoration = decoration;
}
...
const LinksStyles = () => {
    ...
    return (
        <>
            <div className='list'>
                <p className='itemList'>link</p>
                <div className='styleButtons'>
                    <input value={ linkContent } onChange={(e) => { setLinkContent(e.target.value) }} />
                    <button className='addAndStyleButton' onClick={ () => setHrefContent(linkContent, secondSectionElement) }>submit</button>
                </div>
            </div>
            <div className='list'>
            ...
            <div className='list'>
                <p className='itemList'>text decoration</p>
                <div className='styleButtons'>
                    <button className='addAndStyleButton' onClick={ () => setTextDecoration('unset', secondSectionElement) }>unset</button>
                    <button className='addAndStyleButton' onClick={ () => setTextDecoration('none', secondSectionElement) }>none</button>
                </div>
            </div>
            <div className='list'>
